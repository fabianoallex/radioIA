...
async def _build_all(texts: dict, voice: str, rate: str, temp_dir: str,
                     provider) -> dict[str, AudioSegment]:
    results = {}
...
def generate_vinhetas(config: dict, temp_dir: str,
                      tts_config: dict = None) -> dict[str, AudioSegment]:
